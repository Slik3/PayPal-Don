# Contribuer pour L'API Paypal de Don
...
S'il vous plaît ne pas utiliser les issues pour les demandes de soutien en cas de problème d'installation, les explications sur l'installation sont citées dans le [README.md](https://github.com/Slik3/PayPal-Don/blob/master/README.md).
...
* `Question` - Les questions sur l'application ou vous n'avez pas la réponse sur le [README.md](https://github.com/Slik3/PayPal-Don/blob/master/README.md).


## Les issues bugs
Pour toutes envoies d'issue sur des bugs, merci de bien expliquer votre problème en citant les **étapes que vous avez effectuées**, la **configuration de votre environnement**, d'accompagner d'un ou plusieurs **screenshots** si besoin et d'avoir vérifié la documentation sur le [README.md](https://github.com/Slik3/PayPal-Don/blob/master/README.md) avant de poster.
